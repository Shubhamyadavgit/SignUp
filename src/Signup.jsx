...
const Signup = () => {
  ...
  const handleSendEmailOtp = async () => {
    try {
      const response = await axios.post(
        "http://localhost:8080/api/users/otp/send",
        {
          email: data.email,
        }
      );
      ...
      const errorMessage =
        error.response?.data || "Error sending OTP. Please try again.";
  ...
  const handleOtpVerificationEmail = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/api/users/otp/verify",
        {
          ...
          {emailOtpVisible && (
            <div className="otp-input-container">
              ...
              <input
                ...
                required
              />
              <button type="button" onClick={handleOtpVerificationEmail}>
                Verify OTP
              </button>
            </div>
          )}
          ...
          {phoneOtpVisible && (
            <div className="otp-input-container">
              ...
              <input
                ...
                required
              />
              <button type="button" onClick={handleOtpVerificationPhone}>
                Verify OTP
              </button>
            </div>
          )}
